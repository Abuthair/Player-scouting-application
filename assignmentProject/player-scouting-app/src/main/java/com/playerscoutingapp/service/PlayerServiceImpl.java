...
public class PlayerServiceImpl  implements  IPlayerService{
     ...
     */
    @Override
    public List<Player> getByName(String playerName) throws PlayerNotFoundException {
        List<Player> players =iPlayerRepository.findByName(playerName);
        if (players.isEmpty()){
            throw new PlayerNotFoundException("Player Not Found");
        }
        return players;
    ...
    /**
     * getByLeague this method implementation will allow us to get team using league
     * @param league
     * @return players
     * @throws TeamNotFoundException
     */
    @Override
    public List<Player> getByLeague(String league) throws TeamNotFoundException {
       List<Player> players = iPlayerRepository.findByLeague(league);
       if (players.isEmpty()){
           throw new TeamNotFoundException("League Not Found");
       }
        return players;
    }
     ...
     */
    @Override
    public List<Player> getByNameCountry(String name, String country) throws PlayerNotFoundException {
      List<Player> players =iPlayerRepository.findByNameCountry(name,country);
      if (players.isEmpty()){
          throw new PlayerNotFoundException("Player Not Found");
      }
        return players;
     ...
     */
    @Override
    public List<Player> getByPriceBetween(int basePrice1, int basePrice2) throws PlayerNotFoundException {
