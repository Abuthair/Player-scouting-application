...
public interface IPlayerService {
     ...
     * @throws PlayerNotFoundException
     */
    List<Player> getByName(String playerName)throws  PlayerNotFoundException;
    ...
    /**
     * getByLeague this method is used to get the team using league
     * @param league
     * @throws TeamNotFoundException
     */
    List<Player> getByLeague(String league) throws TeamNotFoundException;
     ...
     * @throws PlayerNotFoundException
     */
    List<Player> getByNameCountry(String name, String country) throws PlayerNotFoundException;
    ...
    /**
     * getByPriceBetween this method is used to get the players better basePrice1 and BasePrice2
     * @param basePrice1
     * @param basePrice2
     * @throws PlayerNotFoundException
     */
    List<Player> getByPriceBetween(int basePrice1,int basePrice2) throws PlayerNotFoundException;
